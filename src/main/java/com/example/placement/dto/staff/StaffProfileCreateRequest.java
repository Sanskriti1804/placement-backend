...
public class StaffProfileCreateRequest {
    ...
    private List<StaffManagedRoleRequest> managedRoles = new ArrayList<>();
    private List<StaffProfessionalExperienceRequest> professionalExperiences = new ArrayList<>();
    ...
    public List<StaffManagedRoleRequest> getManagedRoles() {
        return managedRoles;
    }

    public void setManagedRoles(List<StaffManagedRoleRequest> managedRoles) {
        this.managedRoles = managedRoles;
    }

    public List<StaffProfessionalExperienceRequest> getProfessionalExperiences() {
        return professionalExperiences;
    }

    public void setProfessionalExperiences(List<StaffProfessionalExperienceRequest> professionalExperiences) {
