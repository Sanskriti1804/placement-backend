...
public class JobUpdateRequest {
    ...
    private List<JobSelectionRoundUpdateRequest> selectionRounds = new ArrayList<>();
    ...
    public List<JobSelectionRoundUpdateRequest> getSelectionRounds() {
        return selectionRounds;
    }

    public void setSelectionRounds(List<JobSelectionRoundUpdateRequest> selectionRounds) {
