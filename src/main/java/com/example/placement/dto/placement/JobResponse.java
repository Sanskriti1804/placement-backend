...
public class JobResponse {
    ...
    private List<JobSelectionRoundResponse> selectionRounds = new ArrayList<>();
    ...
    public List<JobSelectionRoundResponse> getSelectionRounds() {
        return selectionRounds;
    }

    public void setSelectionRounds(List<JobSelectionRoundResponse> selectionRounds) {
